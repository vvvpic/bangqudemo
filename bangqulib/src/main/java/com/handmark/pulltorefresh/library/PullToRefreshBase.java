...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    protected final void setHeaderScroll(int value) {
        if (DEBUG) {
            Log.d(LOG_TAG, "setHeaderScroll: " + value); //修改检测下来高度
            if (droDown!=null) {
                droDown.droDownback(value);
            }
        }
    ...
    public static DroDown droDown;

    public static void setInterface(DroDown droDownInteface) {
        droDown = droDownInteface;
    }
