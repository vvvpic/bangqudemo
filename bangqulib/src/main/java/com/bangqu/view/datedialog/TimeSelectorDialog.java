package com.bangqu.view.datedialog;
...
public class TimeSelectorDialog extends Dialog {
    ...
    private View view_time_select_empty;
    ...
    public TimeSelectorDialog(Context context) {
        ...
        view_time_select_empty=(View)findViewById(R.id.view_time_select_empty);
    }
    ...
    public void setEmptyIsShow(boolean isShow){
        if(isShow){
            ...
            view_time_select_empty.setVisibility(View.VISIBLE);
        }
        else {
            btn2.setVisibility(View.GONE);
            view_time_select_empty.setVisibility(View.GONE);
        }
    }
