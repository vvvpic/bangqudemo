...
public abstract class BaseFragment extends Fragment implements InitListener, OnClickListener, ReceiveListener {
    ...
    public void initHead() {
        ...
        material_back_button = (MaterialMenuView) view.findViewById(R.id.material_back_button);
    ...
    public void otherPost(final String Url, final String requestname, RequestParams params) {
        ...
        httpClient.post(getActivity(), Url + requestname + ".json", params, new AsyncHttpResponseHandler() {
            @Override
            public void onStart() {
            }
