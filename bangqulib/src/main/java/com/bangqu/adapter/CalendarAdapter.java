...
import com.bangqu.utils.LunarCalendar;
import com.bangqu.utils.SpecialCalendar;
...
public class CalendarAdapter extends BaseAdapter {
	...
	private int CurrentSlected=-1;

	public void setCurrentSlected(int CurrentSlected){
		this.CurrentSlected=CurrentSlected;
...
//			drawable = res.getDrawable(R.drawable.calendar_item_selected_bg);
			drawable = new ColorDrawable(Color.rgb(3, 169, 244));
			if (position % 7 == 0 || position % 7 == 6) {
				// 当前月信息显示
				textView.setTextColor(Color.rgb(3, 169, 244));// 当月字体设黑
//				drawable = res.getDrawable(R.drawable.calendar_item_selected_bg);
				drawable = new ColorDrawable(Color.rgb(3, 169, 244));
			}
		}
		...
		if (currentFlag == position) {
			// 设置当天的背景
//			drawable = res.getDrawable(R.drawable.calendar_item_selected_bg);
			drawable = new ColorDrawable(Color.rgb(15, 185, 2));
			textView.setBackgroundDrawable(drawable);
			textView.setTextColor(Color.WHITE);
		}

		if (CurrentSlected!=currentFlag&&CurrentSlected==position){
			drawable = new ColorDrawable(Color.rgb(3, 169, 244));
			textView.setBackgroundDrawable(drawable);
			textView.setTextColor(Color.WHITE);
		}
