package com.bangqu.yishi.wxapi;
...
public class WXEntryActivity extends BaseActivity implements IWXAPIEventHandler {
    ...
    public void onCreate(Bundle savedInstanceState) {
		 ...
		 * 微信
		*/
		api= WXAPIFactory.createWXAPI(this, "wxce3287b52eccea84",true);
...
//				Constants.getcode = sp.code;
	...
	public void getWxResult(final String code) {
		...
		params.put("appid", "wxce3287b52eccea84");
		params.put("secret", "804d96333062015032434c1cfe96c23c");
